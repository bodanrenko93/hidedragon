...
static const wchar_t	ClassName[] = L"Browser Example";
...
HRESULT STDMETHODCALLTYPE Site_QueryInterface(IOleInPlaceSite FAR* This,
											  REFIID riid, void ** ppvObject);
HRESULT STDMETHODCALLTYPE Site_AddRef(IOleInPlaceSite FAR* This);
HRESULT STDMETHODCALLTYPE Site_Release(IOleInPlaceSite FAR* This);
HRESULT STDMETHODCALLTYPE Site_SaveObject(IOleClientSite FAR* This);
HRESULT STDMETHODCALLTYPE Site_GetMoniker(IOleClientSite FAR* This, DWORD dwAssign,
										  DWORD dwWhichMoniker, IMoniker ** ppmk);
HRESULT STDMETHODCALLTYPE Site_GetContainer(IOleClientSite FAR* This, 
...
long EmbedBrowserObject(HWND hwnd)
{
	...
	if (!OleCreate(&CLSID_WebBrowser, &IID_IOleObject, OLERENDER_DRAW, 0, (IOleClientSite *)_iOleClientSiteEx, 
		&MyIStorage, (void**)&browserObject))
	{
		...
		*((IOleObject **)ptr) = browserObject;
			...
			!browserObject->lpVtbl->QueryInterface(browserObject, &IID_IWebBrowser2, (void**)&webBrowser2))
		{
			...
			webBrowser2->lpVtbl->put_Width(webBrowser2, /*300*/rect.right);
			webBrowser2->lpVtbl->put_Height(webBrowser2, /*300*/rect.bottom);
...
long SetBrowserRect(HWND hwnd,HWND * pWnd)
{
	IOleObject			*browserObject;
	IWebBrowser2		*webBrowser2;
	RECT				rect;
...
//			webBrowser2->lpVtbl->put_Height(webBrowser2, rect.bottom);
			HWND hTemp;
			webBrowser2->lpVtbl->get_HWND(webBrowser2,(SHANDLE_PTR *)pWnd);
			webBrowser2->lpVtbl->get_HWND(webBrowser2,(SHANDLE_PTR *)&hTemp);
