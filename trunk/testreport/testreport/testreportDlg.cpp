...
BEGIN_DHTML_EVENT_MAP(CtestreportDlg)
...
CtestreportDlg::CtestreportDlg(CWnd* pParent /*=NULL*/)
	: CDHtmlDialog(CtestreportDlg::IDD, CtestreportDlg::IDH, pParent)
{
...
BEGIN_MESSAGE_MAP(CtestreportDlg, CDHtmlDialog)
	ON_WM_SYSCOMMAND()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
HRESULT CtestreportDlg::OnButtonOK(IHTMLElement* /*pElement*/)
{
	OnOK();
	return S_OK;
}

HRESULT CtestreportDlg::OnButtonCancel(IHTMLElement* /*pElement*/)
{
	OnCancel();
	return S_OK;
}
