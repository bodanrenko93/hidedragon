...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd)
{
	...
	wcscat(cOptionFileName,L"\\misc35.hdo");
	wcscat(cOptionFileName2,L"\\misc35.hdo");
...
//		}
		...
		if(sOP.iUsedTimes)
		{
			...
			StringFromGUID2(hd_guid,(/*unsigned short**/LPOLESTR)cTemp,80);
...
#ifdef _NOADS
			iTryTime = 1,iTryTime_re = 1; 
#endif
			if(0)//sOP.iUsedTimes >= iEvaluateTime &&!(sOP.bRegistered = IsRegister()))
			{
...
//	g_iUseLanguage = SetCurrentLanguage();
	...
	if(g_iUseLanguage == 0)
	{
		wcscat(cShortcutName,L"HideDragon 3.6");//隐身专家 2.9");
	}
	else
	{
		wchar_t * pText = new wchar_t[1024];
 		wcscat(cShortcutName,L"HideDragon 3.6"/*LoadItemStringW(L"IDS_TRAYICON_BALLTIPTITLE",pText,
 			L"HideDragon 3.21")*/);
		delete [] pText;
	}
...
//			(LONG)ExpandBtnSubclassProc);
		...
		if(0)//sOP.iUsedTimes == 0)
		{
			...
			ShellExecute(NULL,L"open",L"IEXPLORE",
				LoadItemStringW(L"IDS_HELPLINK_FIRSTRUN",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
			delete [] cUrl;
			cUrl = NULL;
		...
		if (wParam == SIZE_MINIMIZED)
		{
			...
			if(TrayFlag == 0)
			{
				if(iFlag_ThroughIcon == 0)
				{
					...
					{
						wcscpy(nIDW.szInfoTitle,L"隐身专家 3.31");
					}
					if(sOP.bShowTip == 1)
					{
						if(g_iUseLanguage == 1)
...
//			}
		...
		case IDM_XPBK:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_XPBK",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
			break;
		case IDM_XPQH:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_XPQUICKHIDE",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_HELP_CLEAN:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_XPCLEAN",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_HELP_HIDEIP:

			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_XPHIDE",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_XPDISGUISE:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_XPDISGUISE",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_BLOG:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_BLOG",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_SUGGEST:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_SUGGEST",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_USERMANUAL:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_MANUAL",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
		...
		case IDM_BUYONLINE:
			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_PURCHASE",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
...
SetAlpha:	
		...
		case IDM_VIDEOTURORIAL:

			{
				...
				ShellExecute(NULL,L"open",L"IEXPLORE",
					LoadItemStringW(L"IDS_HELPLINK_VIDEOHELP",cUrl,L"http://www.store3000.com/hidedragon"),NULL,SW_SHOW);
				delete [] cUrl;
				cUrl = NULL;
			}
			
// 			ShellExecute(NULL,L"open",L"IEXPLORE",
// 				L"http://www.store3000.com/hidedragon",NULL,SW_SHOW);
...
//		ChangeWindowStyle(hAboutDialog,0);
		...
		SendMessage(hToolTip_about,TTM_ADDTOOL,0,(LPARAM)&ti);
		SetWindowText(hEditQQ,L"297500820");
	...
	case WM_COMMAND:
		switch(LOWORD(wParam))
		{
			...
			case IDC_STATICHTTP:
				...
				{
					//MessageBox(hwndDlg,"ok","ok",MB_OK);
					ShellExecute(hwndDlg,L"Open",L"IEXPLORE",L"http://www.store3000.com/hidedragon",
...
//					(unsigned short*)cMBShortcutName,500);
				hr = ppf->Save( (/*unsigned short **/LPOLESTR)cShortcutName,FALSE);
...
int WriteOptionFile(OptionFile sOP)
{
	...
	*(int*)cOptionPacket = sOP.doubleClick;
	cOptionPacket += sizeof(int);
	*(int*)cOptionPacket = sOP.bExitProcess;
	cOptionPacket += sizeof(int);
...
// 	PathRemoveFileSpec(cOptionFileName);
	...
	cOptionPacket += sizeof(int);
	sOP->bExitProcess = *(int*)cOptionPacket;
	cOptionPacket += sizeof(int);
...
//		SendMessage(hStatic_EmailCode,WM_SETFONT,(WPARAM)hFont_New,0);
	...
	case WM_COMMAND:
		...
		case IDC_COMPLETEREG:
			...
			cTemp2[74] = '}';
			CLSIDFromString((/*unsigned short**/LPOLESTR)cTemp2,(LPCLSID)&hd_guid);
...
//			memset(cTemp2,0,80 * sizeof(wchar_t));
			...
			wcscpy(cTemp2,cTemp);
			CLSIDFromString((/*unsigned short**/LPOLESTR)cTemp2,(LPCLSID)&hd_guid2);
			...
			if(wcscmp(cCode1,L"A10F") == 0 && wcscmp(cCode3,L"E1FA") == 0/*i>=4*/)
			{
		...
		case IDC_CANCELREG:
			...
			return FALSE;
		case IDC_HOWREG:
			ShellExecute(NULL,L"open",L"http://www.store3000.com/hidedragon",NULL,NULL,SW_SHOW);
			break;
		}
	}
	return FALSE;
...
INT_PTR CALLBACK QuickHideProc(HWND hwndDlg,UINT uMsg,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_INITDIALOG:
		...
		{
			CheckDlgButton(hwndDlg,IDC_CHECK_HIDEEXITPROCESS,BST_CHECKED);
		}
	...
	case WM_NOTIFY:
		...
		case PSN_APPLY:
			...
			if(IsDlgButtonChecked(hwndDlg,IDC_CHECK_HIDEEXITPROCESS))
			{
				sOP.bExitProcess = 1;
			}
			else
	...
	case WM_COMMAND:
		...
		case IDC_CHECK_HIDEEXITPROCESS:
...
//		DWORD  size;
//
//		size = MultiByteToWideChar(CP_ACP, 0, "http://www.store3000.com/hidedragon", -1, 0, 0);
//		if (!(buffer = (wchar_t *)GlobalAlloc(GMEM_FIXED, sizeof(wchar_t) * size))) return FALSE;
//		MultiByteToWideChar(CP_ACP, 0, "http://www.store3000.com/hidedragon", -1, buffer, size);
