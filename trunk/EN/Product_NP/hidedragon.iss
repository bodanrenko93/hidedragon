...
[Setup]
AppName=HideDragon 3.4
AppCopyright=Copyright (C) 2003 - 2008.12 HideDragon
AppVerName=HideDragon 3.4
...
DefaultGroupName=HideDragon 3.4
...
OutputBaseFilename=HideDragon34
Compression=lzma
SolidCompression=yes
VersionInfoVersion=3.4
VersionInfoDescription=HideDragon 3.4
...
Source: "d:\My Program\T2\En\Product_NP\Misc34.hdo"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\HideDragon 3.4"; Filename: "{app}\HideDragon.exe";WorkingDir: "{app}";
Name: "{userdesktop}\HideDragon 3.4"; Filename: "{app}\HideDragon.exe"; Tasks: desktopicon ;WorkingDir: "{app}";
;Name: "{group}\{cm:ProgramOnTheWeb,HideDragon 3.4}"; Filename: "{app}\HideDragon.url";
Name: "{group}\Buy"; Filename: "{app}\BuyHideDragon.url";
Name: "{group}\HideDragon Manual"; Filename: "{app}\ManualHideDragon.url";
Name: "{group}\Uninstall"; Filename: "{app}\unins000.exe";

[Run]
Filename: "{app}\HideDragon.exe"; Description: "{cm:LaunchProgram,HideDragon 3.4}"; Flags: nowait postinstall skipifsilent
