...
//		wchar_t * pNameW = new wchar_t[1024];
//		memset(pNameW,0,1024);
//		WideCharToMultiByte(CP_ACP,WC_NO_BEST_FIT_CHARS,pName,1024,pNameW,1024,NULL,FALSE);
//
//		HANDLE hSettingFile = CreateFileW(pNameW,GENERIC_READ|GENERIC_WRITE,
